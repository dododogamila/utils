...
public class RandomUtil {
    ...
    public static final String ALLMINCHAR = "0123456789abcdefghijklmnopqrstuvwxyz";
    ...
    public static String generateMinString(int length) {
        ...
        Random random = new Random();
        for (int i = 0; i < length; i++) {
            sb.append(ALLCHAR.charAt(random.nextInt(ALLMINCHAR.length())));
        }
        return sb.toString();
    }
    ...
    public static void main(String[] args) {
        System.out.println(generateInt(32));
