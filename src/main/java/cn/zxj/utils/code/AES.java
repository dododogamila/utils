...
//		org.noe.framework.util.log.Log.debug("100��php ���Խ�� �� ");

        // <?php
        // $AesKey = "ab23key#iLily*@i!mvpabc123i#!0mn";
        // include_once('AES/AES.class.php');
        // $AES = new AES ( $AesKey, 'ECB', $AesKey );
        // echo
        // "{\"28b4cf522f545dbb:0.412095557ad3592120fb31ccbe8507e2602df395\",\"".
        // base64_encode($AES->encrypt("28b4cf522f545dbb:0.412095557ad3592120fb31ccbe8507e2602df395"))
        // ."\"},\n" ;
        // echo
        // "{\"fe5e3a208ecbab4e:0.46209484fdc021ebe5c1342ce1c63c96d667cb96\",\"".
        // base64_encode($AES->encrypt("fe5e3a208ecbab4e:0.46209484fdc021ebe5c1342ce1c63c96d667cb96"))
        // ."\"},\n" ;
        // echo
        // "{\"6fdef75a26a95c6e:0.6807415b5b9d29418ea693c1e475d15862eee9c\",\"".
        // base64_encode($AES->encrypt("6fdef75a26a95c6e:0.6807415b5b9d29418ea693c1e475d15862eee9c"))
        // ."\"},\n" ;
        // echo
        // "{\"45650d8107ac3bd0:0.80778867ebd3e3ebdd79a377c5de6199bd53b90\",\"".
        // base64_encode($AES->encrypt("45650d8107ac3bd0:0.80778867ebd3e3ebdd79a377c5de6199bd53b90"))
        // ."\"},\n" ;
        // echo
        // "{\"c04d843d295745bb:0.08127308808c2678b8c9b91681ac8bb326a2cede\",\"".
        // base64_encode($AES->encrypt("c04d843d295745bb:0.08127308808c2678b8c9b91681ac8bb326a2cede"))
        // ."\"},\n" ;
        // echo
        // "{\"443a9fde9fabb8df:0.9422851b88103c4a65a4662185bfc8ad2724621\",\"".
        // base64_encode($AES->encrypt("443a9fde9fabb8df:0.9422851b88103c4a65a4662185bfc8ad2724621"))
        // ."\"},\n" ;
        // echo
        // "{\"17a580c4220cc15d:0.581728168e853b90014557dd60700b371c3210f7\",\"".
        // base64_encode($AES->encrypt("17a580c4220cc15d:0.581728168e853b90014557dd60700b371c3210f7"))
        // ."\"},\n" ;
        // echo
        // "{\"bc55b70cec56f86d:0.9149864bb50a2cd8ee8a2e4340fed528f0df1f\",\"".
        // base64_encode($AES->encrypt("bc55b70cec56f86d:0.9149864bb50a2cd8ee8a2e4340fed528f0df1f"))
        // ."\"},\n" ;
        // echo
        // "{\"f00742fb655ef4f9:0.5144630767b843b1fef1da791c288fa5fdd6d54\",\"".
        // base64_encode($AES->encrypt("f00742fb655ef4f9:0.5144630767b843b1fef1da791c288fa5fdd6d54"))
        // ."\"},\n" ;
        // echo
        // "{\"b1762d957376e7f9:0.869291845d740b7b2532691ffeb9bee1500abe72\",\"".
        // base64_encode($AES->encrypt("b1762d957376e7f9:0.869291845d740b7b2532691ffeb9bee1500abe72"))
        // ."\"},\n" ;
        // echo
        // "{\"6f087aa379c6b9ea:0.85844728e59cd9368e4d993d66801e999733200\",\"".
        // base64_encode($AES->encrypt("6f087aa379c6b9ea:0.85844728e59cd9368e4d993d66801e999733200"))
        // ."\"},\n" ;
        // echo
        // "{\"9892cd1e66b89130:0.1120951842f21742bb71708888afb3d713802250\",\"".
        // base64_encode($AES->encrypt("9892cd1e66b89130:0.1120951842f21742bb71708888afb3d713802250"))
        // ."\"},\n" ;
        // echo
        // "{\"ed80afd1b5c86a85:0.060889184354b878f92f240ab44fa5605268f735a\",\"".
        // base64_encode($AES->encrypt("ed80afd1b5c86a85:0.060889184354b878f92f240ab44fa5605268f735a"))
        // ."\"},\n" ;
        // echo
        // "{\"f25ecca3330c0ada:0.80230296cfee76710bfa71259fba1440c5e49ed1\",\"".
        // base64_encode($AES->encrypt("f25ecca3330c0ada:0.80230296cfee76710bfa71259fba1440c5e49ed1"))
        // ."\"},\n" ;
        // echo
        // "{\"d0363393eb051fc8:0.252948282dab6121184b8e36f020c61eef92c6bd\",\"".
        // base64_encode($AES->encrypt("d0363393eb051fc8:0.252948282dab6121184b8e36f020c61eef92c6bd"))
        // ."\"},\n" ;
        // echo
        // "{\"3749c3a3fce5bae1:0.23963672bb662e1e47386668875d9259404b0272\",\"".
        // base64_encode($AES->encrypt("3749c3a3fce5bae1:0.23963672bb662e1e47386668875d9259404b0272"))
        // ."\"},\n" ;
        // echo
        // "{\"a5018099a57c1fab:0.7870552bfed1204e8e1cc72c563e78c6d0d547e\",\"".
        // base64_encode($AES->encrypt("a5018099a57c1fab:0.7870552bfed1204e8e1cc72c563e78c6d0d547e"))
        // ."\"},\n" ;
        // echo
        // "{\"a82790e43a009297:0.69746846aef8f19998a6804bdf83dd2722c89a18\",\"".
        // base64_encode($AES->encrypt("a82790e43a009297:0.69746846aef8f19998a6804bdf83dd2722c89a18"))
        // ."\"},\n" ;
        // echo
        // "{\"aee02c6a08be5192:0.2518726670554547f5b610b1e154c2c252a01ed3\",\"".
        // base64_encode($AES->encrypt("aee02c6a08be5192:0.2518726670554547f5b610b1e154c2c252a01ed3"))
        // ."\"},\n" ;
        // echo
        // "{\"9a821e4a720d1887:0.8306036283a764193446ffcede19734a39b30b4\",\"".
        // base64_encode($AES->encrypt("9a821e4a720d1887:0.8306036283a764193446ffcede19734a39b30b4"))
        // ."\"},\n" ;
        // echo
        // "{\"8dce618d02142196:0.3511570767188bb31ebf6b421e8a591dc3ef7175\",\"".
        // base64_encode($AES->encrypt("8dce618d02142196:0.3511570767188bb31ebf6b421e8a591dc3ef7175"))
        // ."\"},\n" ;
        // echo
        // "{\"e8c2e4ff4861b375:0.918507649b731b31026b2a8279abd807715b559f\",\"".
        // base64_encode($AES->encrypt("e8c2e4ff4861b375:0.918507649b731b31026b2a8279abd807715b559f"))
        // ."\"},\n" ;
        // echo
        // "{\"1e0b79a3d3501c93:0.8551119676a1c45a16e7446aee78342c0bc1a23\",\"".
        // base64_encode($AES->encrypt("1e0b79a3d3501c93:0.8551119676a1c45a16e7446aee78342c0bc1a23"))
        // ."\"},\n" ;
        // echo
        // "{\"c5eebe28dcbd05c:0.849439868c86e51ec9347157ded979d293c9235\",\"".
        // base64_encode($AES->encrypt("c5eebe28dcbd05c:0.849439868c86e51ec9347157ded979d293c9235"))
        // ."\"},\n" ;
        // echo
        // "{\"587a426f7d910e43:0.279873240bb1ac300459a1620e44ccef16f5c54\",\"".
        // base64_encode($AES->encrypt("587a426f7d910e43:0.279873240bb1ac300459a1620e44ccef16f5c54"))
        // ."\"},\n" ;
        // echo
        // "{\"6c367fed031fb984:0.62549057fe74eb7ec7fb8266b8b23a1cce1926b\",\"".
        // base64_encode($AES->encrypt("6c367fed031fb984:0.62549057fe74eb7ec7fb8266b8b23a1cce1926b"))
        // ."\"},\n" ;
        // echo
        // "{\"6123d32d271057d2:0.91148305c511eb7c433714016a1973626d831aaa\",\"".
        // base64_encode($AES->encrypt("6123d32d271057d2:0.91148305c511eb7c433714016a1973626d831aaa"))
        // ."\"},\n" ;
        // echo
        // "{\"c9566914b094570e:0.6204537a0cf384e68b9154b9edd041ae6c4ad4b\",\"".
        // base64_encode($AES->encrypt("c9566914b094570e:0.6204537a0cf384e68b9154b9edd041ae6c4ad4b"))
        // ."\"},\n" ;
        // echo
        // "{\"2d9227df846ae0a9:0.5822323e90d8e5b2d4708cd045ce2073557f11\",\"".
        // base64_encode($AES->encrypt("2d9227df846ae0a9:0.5822323e90d8e5b2d4708cd045ce2073557f11"))
        // ."\"},\n" ;
        // echo
        // "{\"64aeafcc2588297f:0.6394259a36ab7349737d188795d11a949fb0199\",\"".
        // base64_encode($AES->encrypt("64aeafcc2588297f:0.6394259a36ab7349737d188795d11a949fb0199"))
        // ."\"},\n" ;
        // echo
        // "{\"59f10e5415ba3c63:0.739622065c564a940b2c307b359ef03cc5400e93\",\"".
        // base64_encode($AES->encrypt("59f10e5415ba3c63:0.739622065c564a940b2c307b359ef03cc5400e93"))
        // ."\"},\n" ;
        // echo
        // "{\"d1d276439c82ad39:0.23375571e067a96e55dadcababee01c901de5012\",\"".
        // base64_encode($AES->encrypt("d1d276439c82ad39:0.23375571e067a96e55dadcababee01c901de5012"))
        // ."\"},\n" ;
        // echo
        // "{\"a484dcfd8b99b828:0.360818925008d6aa208d50454f06a42ff4ada03b\",\"".
        // base64_encode($AES->encrypt("a484dcfd8b99b828:0.360818925008d6aa208d50454f06a42ff4ada03b"))
        // ."\"},\n" ;
        // echo
        // "{\"30ebc5e4cbff89e1:0.85476416ac2be3a97a701fb9ab06e59147f83005\",\"".
        // base64_encode($AES->encrypt("30ebc5e4cbff89e1:0.85476416ac2be3a97a701fb9ab06e59147f83005"))
        // ."\"},\n" ;
        // echo
        // "{\"c678fe0cee60c6ea:0.6080759dfdbddee8e4a17d196fbb69ccc02ae9f\",\"".
        // base64_encode($AES->encrypt("c678fe0cee60c6ea:0.6080759dfdbddee8e4a17d196fbb69ccc02ae9f"))
        // ."\"},\n" ;
        // echo
        // "{\"a77fccc2666b8b22:0.162698697172923fc93c539f7fce15d31b8ffc36\",\"".
        // base64_encode($AES->encrypt("a77fccc2666b8b22:0.162698697172923fc93c539f7fce15d31b8ffc36"))
        // ."\"},\n" ;
        // echo
        // "{\"fd88213fad2e0731:0.39493972df02f7ff025f947db6ff3f22765701f6\",\"".
        // base64_encode($AES->encrypt("fd88213fad2e0731:0.39493972df02f7ff025f947db6ff3f22765701f6"))
        // ."\"},\n" ;
        // echo
        // "{\"35c5aff886d3f04a:0.5185545743d459d23a3eae9abe585bb6e5873540\",\"".
        // base64_encode($AES->encrypt("35c5aff886d3f04a:0.5185545743d459d23a3eae9abe585bb6e5873540"))
        // ."\"},\n" ;
        // echo
        // "{\"fd3df5675f97ae72:0.505754957ad388518a4fd3e42de0fa7cd6e74cb8\",\"".
        // base64_encode($AES->encrypt("fd3df5675f97ae72:0.505754957ad388518a4fd3e42de0fa7cd6e74cb8"))
        // ."\"},\n" ;
        // echo
        // "{\"74511f366ce236b6:0.48281854b1d95afe260d201ef1b5df2abf38e401\",\"".
        // base64_encode($AES->encrypt("74511f366ce236b6:0.48281854b1d95afe260d201ef1b5df2abf38e401"))
        // ."\"},\n" ;
        // echo
        // "{\"5db92e906476d535:0.0510865454294360b00c5dde7d319acce441f173b\",\"".
        // base64_encode($AES->encrypt("5db92e906476d535:0.0510865454294360b00c5dde7d319acce441f173b"))
        // ."\"},\n" ;
        // echo
        // "{\"54af0ad213c5af12:0.3514790551dfe3226d991c228c5c14b5253611b2\",\"".
        // base64_encode($AES->encrypt("54af0ad213c5af12:0.3514790551dfe3226d991c228c5c14b5253611b2"))
        // ."\"},\n" ;
        // echo
        // "{\"91ec684dc919bc6e:0.93096874224ffd2483c9ad490f5b3dd366eced1\",\"".
        // base64_encode($AES->encrypt("91ec684dc919bc6e:0.93096874224ffd2483c9ad490f5b3dd366eced1"))
        // ."\"},\n" ;
        // echo
        // "{\"a826914b689affc4:0.8908287b4d503340809e16b65d9a8c0d9184a9\",\"".
        // base64_encode($AES->encrypt("a826914b689affc4:0.8908287b4d503340809e16b65d9a8c0d9184a9"))
        // ."\"},\n" ;
        // echo
        // "{\"4f0eb3a803c7ffd0:0.785000561c63122aca8fd6cc2b3b40ad69ac0b4e\",\"".
        // base64_encode($AES->encrypt("4f0eb3a803c7ffd0:0.785000561c63122aca8fd6cc2b3b40ad69ac0b4e"))
        // ."\"},\n" ;
        // echo
        // "{\"d79a3a077a03bf2b:0.6118892b4c69001376fe0f063341046ef8e80c\",\"".
        // base64_encode($AES->encrypt("d79a3a077a03bf2b:0.6118892b4c69001376fe0f063341046ef8e80c"))
        // ."\"},\n" ;
        // echo
        // "{\"aaa866841294920d:0.21206367b037b1fd4e687db86ca5ecc6eff1b202\",\"".
        // base64_encode($AES->encrypt("aaa866841294920d:0.21206367b037b1fd4e687db86ca5ecc6eff1b202"))
        // ."\"},\n" ;
        // echo
        // "{\"6961329ad5369e77:0.67255567ee23b8f66c69d17aede6cb3329a29d4\",\"".
        // base64_encode($AES->encrypt("6961329ad5369e77:0.67255567ee23b8f66c69d17aede6cb3329a29d4"))
        // ."\"},\n" ;
        // echo
        // "{\"ee269eaf28f1a737:0.63316095305f464ad48c8b65e7fedaffc94e9781\",\"".
        // base64_encode($AES->encrypt("ee269eaf28f1a737:0.63316095305f464ad48c8b65e7fedaffc94e9781"))
        // ."\"},\n" ;
        // echo
        // "{\"bfa8510eef15c23d:0.03074354c48cad400ad73e12a03828d43abd7df1\",\"".
        // base64_encode($AES->encrypt("bfa8510eef15c23d:0.03074354c48cad400ad73e12a03828d43abd7df1"))
        // ."\"},\n" ;
        // echo
        // "{\"ed05ecd995af26c3:0.052431226c70e234c1d7711a14a971ca0464131e1\",\"".
        // base64_encode($AES->encrypt("ed05ecd995af26c3:0.052431226c70e234c1d7711a14a971ca0464131e1"))
        // ."\"},\n" ;
        // echo
        // "{\"9bad68dab964f018:0.14695841d2d2506a572c142eb5aaed8c64ae66e\",\"".
        // base64_encode($AES->encrypt("9bad68dab964f018:0.14695841d2d2506a572c142eb5aaed8c64ae66e"))
        // ."\"},\n" ;
        // echo
        // "{\"72ca541501a531df:0.63025147b4d4fe682c7db2766f56fb400d20e329\",\"".
        // base64_encode($AES->encrypt("72ca541501a531df:0.63025147b4d4fe682c7db2766f56fb400d20e329"))
        // ."\"},\n" ;
        // echo
        // "{\"30dad98a1fc5b8fd:0.72630056e3e27df337b9c15ffff6c28a85cafe6\",\"".
        // base64_encode($AES->encrypt("30dad98a1fc5b8fd:0.72630056e3e27df337b9c15ffff6c28a85cafe6"))
        // ."\"},\n" ;
        // echo
        // "{\"a38d48b447198c15:0.5839692461e335c58c5d0ed0a06cdcb196adf024\",\"".
        // base64_encode($AES->encrypt("a38d48b447198c15:0.5839692461e335c58c5d0ed0a06cdcb196adf024"))
        // ."\"},\n" ;
        // echo
        // "{\"c23e75491babce03:0.75255362eb85832068373724d49b975ec4dceae\",\"".
        // base64_encode($AES->encrypt("c23e75491babce03:0.75255362eb85832068373724d49b975ec4dceae"))
        // ."\"},\n" ;
        // echo
        // "{\"ed702dacc99b9371:0.94814117652763f9ac822dddfa09cab6e269df\",\"".
        // base64_encode($AES->encrypt("ed702dacc99b9371:0.94814117652763f9ac822dddfa09cab6e269df"))
        // ."\"},\n" ;
        // echo
        // "{\"adec2cccecfc9cf:0.067761352491b008a10674f67881737e22dc478\",\"".
        // base64_encode($AES->encrypt("adec2cccecfc9cf:0.067761352491b008a10674f67881737e22dc478"))
        // ."\"},\n" ;
        // echo
        // "{\"e7bf09be06b9c2a6:0.59192772c6002f6f9a82233f7e281f71c2bb875\",\"".
        // base64_encode($AES->encrypt("e7bf09be06b9c2a6:0.59192772c6002f6f9a82233f7e281f71c2bb875"))
        // ."\"},\n" ;
        // echo
        // "{\"8ed081529438fae8:0.47255462fce209e0f4c88caac7c1e932544d7f63\",\"".
        // base64_encode($AES->encrypt("8ed081529438fae8:0.47255462fce209e0f4c88caac7c1e932544d7f63"))
        // ."\"},\n" ;
        // echo
        // "{\"98495e0a2893c2ec:0.6305613bb819f0ade04ed3a76b284cd9f0723f9\",\"".
        // base64_encode($AES->encrypt("98495e0a2893c2ec:0.6305613bb819f0ade04ed3a76b284cd9f0723f9"))
        // ."\"},\n" ;
        // echo
        // "{\"7b3006ace82eb39d:0.243851846dd5842c89e5b5695dbee702545ecaae\",\"".
        // base64_encode($AES->encrypt("7b3006ace82eb39d:0.243851846dd5842c89e5b5695dbee702545ecaae"))
        // ."\"},\n" ;
        // echo
        // "{\"4b193de91f1aac81:0.725807489143510e96a6d278a236828fe663c97\",\"".
        // base64_encode($AES->encrypt("4b193de91f1aac81:0.725807489143510e96a6d278a236828fe663c97"))
        // ."\"},\n" ;
        // echo
        // "{\"a04dde89863c6245:0.392586773cdb39fde82528c03955da2d63af3e85\",\"".
        // base64_encode($AES->encrypt("a04dde89863c6245:0.392586773cdb39fde82528c03955da2d63af3e85"))
        // ."\"},\n" ;
        // echo
        // "{\"3dcf941c396f8c19:0.229768047ded5162f8046430ff8ffc6f45b26d49\",\"".
        // base64_encode($AES->encrypt("3dcf941c396f8c19:0.229768047ded5162f8046430ff8ffc6f45b26d49"))
        // ."\"},\n" ;
        // echo
        // "{\"a08acf8e3b87c8f8:0.4245208a35e59c7469a40314ea95a2ee3406faf\",\"".
        // base64_encode($AES->encrypt("a08acf8e3b87c8f8:0.4245208a35e59c7469a40314ea95a2ee3406faf"))
        // ."\"},\n" ;
        // echo
        // "{\"39e9f3a9915f68a6:0.2803316fe5a0b61f9d96f6969fcfa07ca92e4b8\",\"".
        // base64_encode($AES->encrypt("39e9f3a9915f68a6:0.2803316fe5a0b61f9d96f6969fcfa07ca92e4b8"))
        // ."\"},\n" ;
        // echo
        // "{\"522765c7b29a2621:0.8235934d5b8ada6c54f4c49fd501571202940fa\",\"".
        // base64_encode($AES->encrypt("522765c7b29a2621:0.8235934d5b8ada6c54f4c49fd501571202940fa"))
        // ."\"},\n" ;
        // echo
        // "{\"5d85fb0b3d102835:0.055190623dfad8f39304d771db0c50a3bb3146615\",\"".
        // base64_encode($AES->encrypt("5d85fb0b3d102835:0.055190623dfad8f39304d771db0c50a3bb3146615"))
        // ."\"},\n" ;
        // echo
        // "{\"e8202babb6c18f6e:0.72234317327fcf5034819f7c596a2e692af7b5\",\"".
        // base64_encode($AES->encrypt("e8202babb6c18f6e:0.72234317327fcf5034819f7c596a2e692af7b5"))
        // ."\"},\n" ;
        // echo
        // "{\"6f013e72f266a3d8:0.4715792577a75f60b1a575e542c2eb07e01016\",\"".
        // base64_encode($AES->encrypt("6f013e72f266a3d8:0.4715792577a75f60b1a575e542c2eb07e01016"))
        // ."\"},\n" ;
        // echo
        // "{\"bb8f219e5c92370b:0.123004293a01d8c148349c5cf8aacb481cae1a6\",\"".
        // base64_encode($AES->encrypt("bb8f219e5c92370b:0.123004293a01d8c148349c5cf8aacb481cae1a6"))
        // ."\"},\n" ;
        // echo
        // "{\"a1fd7253a65b49da:0.471956978f1329ea4991f365a0f9afd9061aca58\",\"".
        // base64_encode($AES->encrypt("a1fd7253a65b49da:0.471956978f1329ea4991f365a0f9afd9061aca58"))
        // ."\"},\n" ;
        // echo
        // "{\"239199a8bb745f2c:0.177537022b6256d9be0efd266973088b58c54632\",\"".
        // base64_encode($AES->encrypt("239199a8bb745f2c:0.177537022b6256d9be0efd266973088b58c54632"))
        // ."\"},\n" ;
        // echo
        // "{\"8dd73972c0beaaa7:0.3596304712fcf48e731bf4861ac6158b1dd261d6\",\"".
        // base64_encode($AES->encrypt("8dd73972c0beaaa7:0.3596304712fcf48e731bf4861ac6158b1dd261d6"))
        // ."\"},\n" ;
        // echo
        // "{\"3b0fb001ed857253:0.42678828d4ff4873160120ce90e8053c7fdd5b6\",\"".
        // base64_encode($AES->encrypt("3b0fb001ed857253:0.42678828d4ff4873160120ce90e8053c7fdd5b6"))
        // ."\"},\n" ;
        // echo
        // "{\"45641a241044882f:0.07612777d047206eb70159e57a40c8e5b2dc7b38\",\"".
        // base64_encode($AES->encrypt("45641a241044882f:0.07612777d047206eb70159e57a40c8e5b2dc7b38"))
        // ."\"},\n" ;
        // echo
        // "{\"8ffa58aae49ed5:0.14131373d238e14f7f31023e8ed0bc908d862142\",\"".
        // base64_encode($AES->encrypt("8ffa58aae49ed5:0.14131373d238e14f7f31023e8ed0bc908d862142"))
        // ."\"},\n" ;
        // echo
        // "{\"dbb8c48b2ecc48ba:0.603378061dd224c18300c83c48d8140ca7ecf621\",\"".
        // base64_encode($AES->encrypt("dbb8c48b2ecc48ba:0.603378061dd224c18300c83c48d8140ca7ecf621"))
        // ."\"},\n" ;
        // echo
        // "{\"72b2073771868287:0.3279045242d03a7a9a0cdbf942502b8e3904aa2f\",\"".
        // base64_encode($AES->encrypt("72b2073771868287:0.3279045242d03a7a9a0cdbf942502b8e3904aa2f"))
        // ."\"},\n" ;
        // echo
        // "{\"643c8ff23e165552:0.19478762cd57e9ad08c1c94620f27c304bd936c9\",\"".
        // base64_encode($AES->encrypt("643c8ff23e165552:0.19478762cd57e9ad08c1c94620f27c304bd936c9"))
        // ."\"},\n" ;
        // echo
        // "{\"615fb3cb04d277a2:0.3230084888f5bae3de26743073f4fd2129831c51\",\"".
        // base64_encode($AES->encrypt("615fb3cb04d277a2:0.3230084888f5bae3de26743073f4fd2129831c51"))
        // ."\"},\n" ;
        // echo
        // "{\"1647f7922253c15f:0.857738780b72b7322b9f0b0a5ae254da3e99b82\",\"".
        // base64_encode($AES->encrypt("1647f7922253c15f:0.857738780b72b7322b9f0b0a5ae254da3e99b82"))
        // ."\"},\n" ;
        // echo
        // "{\"224689fcf126fe32:0.76404352c47876f781fcf565486d2ff53c416b3\",\"".
        // base64_encode($AES->encrypt("224689fcf126fe32:0.76404352c47876f781fcf565486d2ff53c416b3"))
        // ."\"},\n" ;
        // echo
        // "{\"4c897760e0c0ec04:0.06847465a961a7fd1f6db89fe5acd81a34553a01\",\"".
        // base64_encode($AES->encrypt("4c897760e0c0ec04:0.06847465a961a7fd1f6db89fe5acd81a34553a01"))
        // ."\"},\n" ;
        // echo
        // "{\"7db5119a11e31dbc:0.42543342c4f5e59586e632245b222d31847d60f\",\"".
        // base64_encode($AES->encrypt("7db5119a11e31dbc:0.42543342c4f5e59586e632245b222d31847d60f"))
        // ."\"},\n" ;
        // echo
        // "{\"485387ca6fac6d56:0.7299434d90b6574f74dea28c86e23738eca6c7d\",\"".
        // base64_encode($AES->encrypt("485387ca6fac6d56:0.7299434d90b6574f74dea28c86e23738eca6c7d"))
        // ."\"},\n" ;
        // echo
        // "{\"3bb596fa582f80d3:0.217410861af71aebb9c09f092c7b515f3979f194\",\"".
        // base64_encode($AES->encrypt("3bb596fa582f80d3:0.217410861af71aebb9c09f092c7b515f3979f194"))
        // ."\"},\n" ;
        // echo
        // "{\"43062b550cece094:0.060832262f054d1f6c3611e50dce7064af502c8fd\",\"".
        // base64_encode($AES->encrypt("43062b550cece094:0.060832262f054d1f6c3611e50dce7064af502c8fd"))
        // ."\"},\n" ;
        // echo
        // "{\"de992e7282fc08d7:0.4203183cf93757483698264840b0e4c11c37592\",\"".
        // base64_encode($AES->encrypt("de992e7282fc08d7:0.4203183cf93757483698264840b0e4c11c37592"))
        // ."\"},\n" ;
        // echo
        // "{\"f3fa9ba3348cc9db:0.05088746553990b7b431c6273b460cfb2856e6571\",\"".
        // base64_encode($AES->encrypt("f3fa9ba3348cc9db:0.05088746553990b7b431c6273b460cfb2856e6571"))
        // ."\"},\n" ;
        // echo
        // "{\"2fb6ff6882ebba19:0.786541468c85739498713e7d88c7e78c5a5d11c\",\"".
        // base64_encode($AES->encrypt("2fb6ff6882ebba19:0.786541468c85739498713e7d88c7e78c5a5d11c"))
        // ."\"},\n" ;
        // echo
        // "{\"4c2db3550c32410e:0.080243778e541c83830cdf1b341ac2990911d973\",\"".
        // base64_encode($AES->encrypt("4c2db3550c32410e:0.080243778e541c83830cdf1b341ac2990911d973"))
        // ."\"},\n" ;
        // echo
        // "{\"7390f2e747d8b910:0.733650451c452f3e8b8ec7faf002dee0199992ca\",\"".
        // base64_encode($AES->encrypt("7390f2e747d8b910:0.733650451c452f3e8b8ec7faf002dee0199992ca"))
        // ."\"},\n" ;
        // echo
        // "{\"e480c8b151ce04f3:0.650018044dc4b5444b829aaff10e575e374ed2b1\",\"".
        // base64_encode($AES->encrypt("e480c8b151ce04f3:0.650018044dc4b5444b829aaff10e575e374ed2b1"))
        // ."\"},\n" ;
        // echo
        // "{\"433711022ea9af67:0.8164916663f03052c021e546fbf8c6f0f14a61c\",\"".
        // base64_encode($AES->encrypt("433711022ea9af67:0.8164916663f03052c021e546fbf8c6f0f14a61c"))
        // ."\"},\n" ;
        // echo
        // "{\"6c155922236470a6:0.0993551653e3b22548cfa1856dcb0135bee05b78\",\"".
        // base64_encode($AES->encrypt("6c155922236470a6:0.0993551653e3b22548cfa1856dcb0135bee05b78"))
        // ."\"},\n" ;
        // echo
        // "{\"b454f57410afe40a:0.71313398d1fd87ec3d5c16b38225568b58ef62c\",\"".
        // base64_encode($AES->encrypt("b454f57410afe40a:0.71313398d1fd87ec3d5c16b38225568b58ef62c"))
        // ."\"},\n" ;
        // echo
        // "{\"e96037e8ce0352f9:0.5676633376e8039ed2133d719f62ee9e3b2df\",\"".
        // base64_encode($AES->encrypt("e96037e8ce0352f9:0.5676633376e8039ed2133d719f62ee9e3b2df"))
        // ."\"},\n" ;
        // echo
        // "{\"a6431f2adc3dab84:0.91788193b10d9edbebe9c4dcac9b72c92f9dbb4\",\"".
        // base64_encode($AES->encrypt("a6431f2adc3dab84:0.91788193b10d9edbebe9c4dcac9b72c92f9dbb4"))
        // ."\"},\n" ;
        // ?>
        ...
        for (String[] arr : checkdata) {
            if (AES.encode(arr[0], key).equals(arr[1])) {
                System.out.println("ok:" + arr[0]);
            } else {
                System.err.println(arr[1]);
                System.exit(0);
            }
        }
        System.out.println("��php AES [www.phpaes.com] ���Ա�  �ԱȲ���ͨ��");
