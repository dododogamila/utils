...
//   }
    ...
    public static void main(String[] args) {
        try {
            System.out.println(SSOBase64.encode(AES.
                    encode("gAyODC+H/0caJlkrgx8AcAUHVzWn78VEGEVcm7/pUvM=".getBytes("UTF-8"), "#s15key#iLily*@i!#vpab#456i#!0#n".getBytes("UTF-8")))
                    .replaceAll("\\n", "").replaceAll("\\r", ""));
            System.out.println(SSOBase64.decode("mk1ey3k6n+ampTviy7yIYA=="));
        } catch (Exception e) {
            e.printStackTrace();
        }
